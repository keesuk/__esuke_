...
const colorObjs = {
    ...
    "gakkaColor": colors["gakka"],
    "gakkaSubColor": colors["skyblue"],
    "gakkaBackColor": colors["white"],
    "gakkaTextColor": colors["black"],
...
const lines = {
    ...
    "subTagLineLightDashed": `0.15rem dahsed ${colorObjs["subTagLineColor"]}`,
