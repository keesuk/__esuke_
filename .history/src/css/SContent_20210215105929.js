...
export const FolioListDiv = styled.div` 
    ...
    .link {
        position: relative;
        width: 100%;
        border: .1rem solid ${colors["greyLight"]};
        box-shadow: 2px 2px 2px ${colors["greyMiddle"]};
    }
    .img {
        width: 100%;
    }
...
export const ImgBox = styled.div`
    ...
    .img {
        ...
        border: .05rem solid ${colors["greyDeep"]};
    }
`;
...
export const Marks = styled.mark`
    ...
    .marksIn {
        ...
        border-top: .06rem solid ${colors["greyAAA"]};
        border-left: .06rem solid ${colors["greyAAA"]};
        border-radius: .5rem;
