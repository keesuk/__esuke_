...
const IndexDiv = styled.div`
    @media (min-width: 2901px) {transform: scale(0.5, 0.5)};

    @media (max-width: 3900px) {transform: scale(0.58, 0.58)};
    @media (max-width: 3650px) {transform: scale(0.56, 0.56)};
    @media (max-width: 3400px) {transform: scale(0.54, 0.54)};
    @media (max-width: 3150px) {transform: scale(0.52, 0.52)};
    @media (max-width: 2900px) {transform: scale(0.5, 0.5)};
    @media (max-width: 2650px) {transform: scale(0.48, 0.48)};
    @media (max-width: 2400px) {transform: scale(0.46, 0.46)};
    @media (max-width: 2150px) {transform: scale(0.44, 0.44)};
    @media (max-width: 1900px) {transform: scale(0.42, 0.42)};
    @media (max-width: 1750px) {transform: scale(0.4, 0.4)};
    @media (max-width: 1400px) {transform: scale(0.38, 0.38)};
    @media (max-width: 1150px) {transform: scale(0.36, 0.36)};
    @media (max-width: 900px) {transform: scale(0.34, 0.34)};
    @media (max-width: 750px) {transform: scale(0.32, 0.32)};
