...
const IndexDiv = styled.div`
    @media (max-width: 2150px) {transform: scale(0.475, 0.475)};
    @media (max-width: 1900px) {transform: scale(0.45, 0.45)};
    @media (max-width: 1750px) {transform: scale(0.425, 0.425)};
    @media (max-width: 1400px) {transform: scale(0.4, 0.4)};
    @media (max-width: 1150px) {transform: scale(0.375, 0.375)};
    @media (max-width: 900px) {transform: scale(0.35, 0.35)};
    @media (max-width: 750px) {transform: scale(0.325, 0.325)};
