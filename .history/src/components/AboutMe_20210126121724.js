...
class Note extends Component{
    ...
    renderDisplay() {
        return (
            <NoteDiv ref={(c) => this._input = c} className='note' style = {this.style}> 
    ...
    renderForm() {
        return(
            <NoteDiv ref="myNote" className='note' style={this.style} >
...
class Board extends Component{
    ...
    render() {
        return(
            <BoardDiv> {this.state.notesStringArray.map(this.eachNote)}
