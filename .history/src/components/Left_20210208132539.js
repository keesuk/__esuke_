            ...
            <div className="title">
                ...
                >
                    <div className="dicContent">
                        <strong>Assignment</strong> To design a new website and shopping experience with a high emphasis on user interactivity and brand content.
                    </div>
                     <div className="dicContent">
                         <strong>Objective</strong> To create a better online e-commerce shopping experience for customers while also increasing awareness between.
                     </div>
                </StickerDiv>
                <StickerDiv
                    rotate={-26}
