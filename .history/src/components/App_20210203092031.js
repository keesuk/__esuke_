...
class App extends Component {
    constructor(props){
        ...
        this._portFolio.bind(this)
        this._aboutMe.bind(this)
        this.postItHandler.bind(this)
        this.postItClose.bind(this)
        this.postItReorder.bind(this)
        this.portFolioClick.bind(this)
    }
    ...
    render(){
        ...
        return(<>
            ...
            <Right>
                <header>
                    <button onClick={()=> this.portFolioClick("Home")}>
                        Home
                    </button>
                </header>
            ...
            <Left>
                <div className="index">
                    {all_portFolio.map(v => 
                        <IndexContent 
                            onClick={() => this.portFolioClick(v["title"])}
                            color={v["color"]}
                            key={v["title"]}
                        >
