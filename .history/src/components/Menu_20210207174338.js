...
const MenuDiv = styled.div`
    @media all (max-width: 2400px){transform: scale(0.9, 0.9)};
    @media all (max-width: 1900px){transform: scale(0.8, 0.8)};
    @media all (max-width: 1400px){transform: scale(0.7, 0.7)};
    @media all (max-width: 900px){transform: scale(0.6, 0.6)};
    @media all (max-width: 400px){transform: scale(0.5, 0.5)};
