    ...
    render(){
        ...
        return(<>
            {menu["AboutMe"] 
                ...
                }<div style={{zIndex: "1000", right:0, top: 0, position: "absolute",width:document.body.clientWidth-X, height: window.innerHeight-Y, backgroundColor: "rgba(255, 255, 255, 0.5)"}}/>
                </>
                : null
            }
            {menu["Contact"] 
