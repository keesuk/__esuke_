...
export const TagAbout = styled.div`
    ...
    .tagContentExp {
        ...
        bottom: .5rem;
        line-height: 1.1rem;
        font-size: ${theme.fontObjs["subTag"]["pageContentExp"]["eng"]["fontSize"]};
        font-style: ${theme.fontObjs["subTag"]["pageContentExp"]["eng"]["fontStyle"]};
        font-weight: ${theme.fontObjs["subTag"]["pageContentExp"]["eng"]["fontWeight"]};
        font-family: ${theme.fontObjs["subTag"]["pageContentExp"]["eng"]["fontFamily"]};
        
        strong {
            margin-left: -5%;
            margin-right: 3%;
            font-weight: ${theme.fontObjs["subTag"]["pageContentExp"]["eng"]["strong"]["fontWeight"]};
        }
    }
    .tagContentList {
        margin-left: 20%;
