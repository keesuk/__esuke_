...
const MenuDiv = styled.div`
    @media (min-width: 1900px){transform: scale(1.2, 1.2)};
    @media (min-width: 1750px){transform: scale(0.95, 0.95)};
    @media (min-width: 1400px){transform: scale(0.9, 0.9)};
    @media (min-width: 1150px){transform:scale(0.85, 0.85)}; 
    @media (min-width: 900px){transform: scale(0.8, 0.8)};
    @media (min-width: 750px){transform: scale(0.75, 0.75)};
    @media (min-width: 400px){transform: scale(0.7, 0.7)};
