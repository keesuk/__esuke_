...
export const TagIntro = styled.div`
    ...
    .tagContentExp {
        ...
        .eng {
            line-height: 1.2rem;
            font-size: ${theme.fontObjs["subTag"]["introContentExpEng"]["fontSize"]};  
            font-style: ${theme.fontObjs["subTag"]["introContentExpEng"]["fontStyle"]};
            font-weight: ${theme.fontObjs["subTag"]["introContentExpEng"]["fontWeight"]};
            font-family: ${theme.fontObjs["subTag"]["introContentExpEng"]["fontFamily"]};
        }
        .kor {
            line-height: 1.2rem;
            font-size: ${theme.fontObjs["subTag"]["introContentExpKor"]["fontSize"]};  
            font-style: ${theme.fontObjs["subTag"]["introContentExpKor"]["fontStyle"]};
            font-weight: ${theme.fontObjs["subTag"]["introContentExpKor"]["fontWeight"]};
            font-family: ${theme.fontObjs["subTag"]["introContentExpKor"]["fontFamily"]};
        }
        ...
        &:before {
            ...
            font-size: ${theme.fontObjs["subTag"]["introContentExpDown"]["fontSize"]};  
            line-height: 3.7rem;
