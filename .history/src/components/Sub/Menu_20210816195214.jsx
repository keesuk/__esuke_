...
class Menu extends Component {
    ...
    postItHandler(about, contact){
        const aboutBool = this.state.menu[about]
        const contactBool = this.state.menu[contact]
        ...
        menuObj[about] = !aboutBool
        menuObj[contact] = !contactBool
    ...
    render(){
        ...
        return(<>
            ...
            <MenuDiv>
                <MenuObj
                    key={menuMenu[0]["title"]}
                    line={menuMenu[0]["line"]}
                    order={menuMenu[0]["order"]}
                > 
                    <button 
                        onClick={()=> this.postItHandler(menuMenu[0]["title"], menuMenu[1]["title"])}
                        className={menu[menuMenu[0]["title"]] ? "postItAfter": "postIt"}
                        style={{backgroundColor: menuMenu[0]["color"]}} 
                    >
                        {menu[menuMenu[0]["title"]] 
                            ? <div className="close">Close All</div>
                            : <div className="open">{menuMenu[0]["title"]}</div>
                        }
                    </button>
                </MenuObj>
            </MenuDiv>
