...
export const TagSticker = styled.div`
    ...
    .stkBack {
        ...
        border-top: ${theme.lines["subTagStkBackLineDark"]};
        border-left: ${theme.lines["subTagStkBackLineDark"]};
        border-bottom: ${theme.lines["subTagStkBackLineLight"]};
        border-right: ${theme.lines["subTagStkBackLineLight"]};
    }
`;
