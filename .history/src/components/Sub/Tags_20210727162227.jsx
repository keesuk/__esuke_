...
export const TagIntro = styled.div`
    ...
    .tagContentExp {
        ...
        .kor {
            ...
            transition: all .8s ease, color 0s, padding 0s, letter-spacing 0s, line-heihgt: 0s;
            color: white;
            border-bottom: .15rem solid #A7844F;
            border-right: .15rem solid #A7844F;
            transform: rotate(${({rotate}) => -rotate}deg);
            ...
            &:before {
                ...
                left: 30%;
                margin: auto;
                background-color: rgba(900, 900, 900, .6);
                width: 20%;
                height: 50%;
