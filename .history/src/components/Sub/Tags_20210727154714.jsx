...
export const TagIntro = styled.div`
    ...
    .tagContentExp {
        ...
        .kor {
            ...
            margin: .2rem;
            background-image: url("https://image.shutterstock.com/image-photo/brown-paper-closeup-260nw-587687360.jpg");
            background-position: center; 
            background-repeat: no-repeat;
            background-size: cover;
            border: .2rem solid #B49260;
            transform: rotate(${({rotate}) => -rotate}deg);
            ...
            &:before {
                ...
                width: 20%;
                height: 50%;
                transform: rotate(${({rotate}) => rotate+10}deg);
            }
        }
