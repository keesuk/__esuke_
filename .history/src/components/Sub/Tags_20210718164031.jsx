...
export const TagAbout = styled.div`
    ...
    .tagContentExp {
        ...
        bottom: .5rem;
        line-height: 1.1rem;
        font-size: ${theme.fontObjs["tagContent"]["fontSize"]};
        font-style: ${theme.fontObjs["tagContent"]["fontStyle"]};
        font-weight: ${theme.fontObjs["tagContent"]["fontWeight"]};
        font-family: ${theme.fontObjs["tagContent"]["fontFamily"]};
