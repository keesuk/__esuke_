...
export const TagIntro = styled.div`
    ...
    .tagContentExp {
        ...
        bottom: .9rem;
        line-height: 1.2rem;
        font-size: ${theme.fontObjs["subTag"]["introContentExp"]["fontSize"]};
        font-style: ${theme.fontObjs["subTag"]["introContentExp"]["fontStyle"]};
        font-weight: ${theme.fontObjs["subTag"]["introContentExp"]["fontWeight"]};
        font-family: ${theme.fontObjs["subTag"]["introContentExp"]["fontFamily"]};
        
        strong {
            margin-left: -5%;
            margin-right: 3%;
            ${theme.fontObjs["subTag"]["introContentExp"]["strong"]["fontWeight"]};
        }
        &:before {
            content: "date";
            display: block;
