...
const MenuObj = styled.div`
    button {
        ...
        height: 65px;
        border: ;
        border-color: ${({deepColor})=> deepColor};
        ...
        .close {
            ...
            color: #ffffff;
            z-index: 100;
            margin-left: ${({leftText})=> leftText};
            margin-top: ${({marginText})=> marginText};
            font-size: 13px;
            font-weight: 600;
            white-space: nowrap;
...
class Menu extends Component {
    ...
    _aboutMe(){
        ...
        aboutMe.map(v => Object.assign(aboutMeObj, {
            [aboutMe.indexOf(v)] : {
                "value": aboutMe.indexOf(v),
                "bool" : false
        }}))
