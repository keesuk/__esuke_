...
class Menu extends Component {
    ...
    _aboutMe(){
        ...
        this.setState({ about : aboutMeObj })
    }
    ...
    postItHandler(v){
        ...
        const aboutMeObj = this.state.about
    ...
    render(){
        const { menu, about, cor }  = this.state
        const { X, Y } = cor

        return(<>
            {menu["AboutMe"] 
                ?   <> 
                    {menuAboutMe.map((v, i) => about[i]["bool"] 
                        ? <AboutMe 
                            X={X}
                            Y={Y}
                            close={this.postItClose}
                            order={this.postItReorder}
                            zValue={about[i]["zValue"]} 
                            img={v["img"]}
                            width={v["width"]}
                            color={v["color"]}
                            borColor={v["borColor"]}
