...
class Menu extends Component {
    ...
    render(){
        ...
        return(<>
            ...
            <MenuDiv>
                <MenuObj
                    key={menuMenu["title"][0]}
                    line={menuMenu["line"][0]}
                    order={menuMenu["order"][0]}
                > 
                    <button 
                        onClick={()=> this.postItHandler(menuMenu["title"][0])}
                        className={menu[menuMenu["title"]] ? "postItAfter": "postIt"}
                        style={{backgroundColor: menuMenu["color"][0]}} 
                    >
                        {menu[menuMenu["title"][0]] 
                            ? <div className="close">Close All</div>
                            : <div className="open">{menuMenu["title"][0]}</div>
                        }
                    </button>
                </MenuObj>
            </MenuDiv>
