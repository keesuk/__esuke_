...
const InnerImgBoxDiv = styled.div`
    ...
    margin-top: ${({marginTop}) => marginTop*0.7}vw;
    margin-bottom: ${({marginBottom}) => marginBottom*0.7}vw;
    padding-top: ${({paddingTop}) => paddingTop*0.7}vw;
    padding-left: ${({paddingLeft}) => paddingLeft*0.7}vw;
    padding-right: ${({paddingRight}) => paddingRight*0.7}vw;
    padding-bottom: ${({paddingBottom}) => paddingBottom*0.7}vw;

`;
const ImgDiv = styled.div`
    height: ${({height}) => height*0.7}vw;
    margin-top: ${({marginTop}) => marginTop*0.7}vw;
    margin-left: ${({marginLeft}) => marginLeft*0.7}vw;
    position: relative;
    .box {
        width: ${({width}) => width}%;
