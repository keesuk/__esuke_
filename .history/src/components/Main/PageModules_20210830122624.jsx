...
const SubText = styled.div`
    ...
    .titleContents {
        ...
        .eng {
            order: ${({LorR}) => LorR === "L" ? "2" : "1"};
            font-size: ${fontObjs["title"]["eng"]["fontSize"]};
            font-family: ${fontObjs["title"]["eng"]["fontFamily"]};
            font-weight: ${fontObjs["title"]["eng"]["fontWeight"]};
            font-style: ${fontObjs["title"]["eng"]["fontStyle"]};
            letter-spacing: -.002rem;
            &:after {
                content: " / ";
                margin-left: -.1rem; 
        ...
        .kor {
            order: ${({LorR}) => LorR === "L" ? "1" : "2"};
            font-size: ${fontObjs["title"]["kor"]["fontSize"]};
            font-family: ${fontObjs["title"]["kor"]["fontFamily"]};
            letter-spacing: -.002rem;
            margin-left: .2rem; 
        }  
    }
