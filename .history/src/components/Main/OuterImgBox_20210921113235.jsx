...
const commonMargin = (marginLeft, marginRight, marginTop, marginBottom) => `
...
const OuterImgBoxDiv = styled.div`
    ${({theme, marginLeft, marginRight, marginTop, marginBottom}) => theme.mobile`
        ${commonMargin(marginLeft, marginRight, marginTop, marginBottom)}
    `}
