...
const OuterImgBoxDiv = styled.div`
    ${({theme}) => theme.mobile`
        height: ${({height}) => height * theme.layoutRatio["ration"]}vw;
        margin-left: ${({marginLeft}) => marginLeft * theme.layoutRatio["ration"]}vw;
        margin-right: ${({marginRight}) => marginRight * theme.layoutRatio["ration"]}vw;
        margin-top: ${({marginTop}) => marginTop * theme.layoutRatio["ration"]}vw;
    `}
