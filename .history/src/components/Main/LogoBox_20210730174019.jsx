...
const TitleBoxLogo = ({
    ...
    return (
        <TitleBoxLogoDiv 
            ...
            logoWidth={logoWidth}
        >   
            <svg style={{position: "absolute", zIndex: "1", marginLeft: "auto", marginRight: "auto", left: "2vw", right: "0"}} className="logoMask">
                <circle id="circle-shadow" cx={x-114} cy={y-114} r="13.2%" style={{ fill: "#fff", zIndex: "100",strokeWidth: "5"}} />
                <defs>
                    <clipPath id="mask">
                        <circle id="mask-circle" cx={x-114} cy={y-114} r="13.2%" style={{fill: "#ffffff", zIndex: "100"}}/>
                    </clipPath>
                </defs>
