...
const TitleBoxLogo = ({
    ...
    return (
        <TitleBoxLogoDiv 
            ...
            logoWidth={logoWidth}
        >   
            <svg style={{position: "absolute", zIndex: "0"}} className="logo">
                <defs>
                    <clipPath id="mask">
                        <circle id="mask-circle" cx={x} cy={y} r="0" style={{fill: "#ffffff"}}/>
                    </clipPath>
                </defs>
                <g clip-path="url(#mask)">
                    {logo}
                </g>
                <circle id="circle-shadow" cx={x} cy={y} r="0" style={{stroke: "#000", fill: "transparent", strokeWidth: "5"}} />
            </svg>
            <svg className="logo">
                {logo}
            </svg>
