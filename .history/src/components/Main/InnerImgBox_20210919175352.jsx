...
const InnerImgBoxDiv = styled.div`
    ...
    margin-bottom: ${({marginBottom}) => marginBottom*1.5}vw;
    padding-top: ${({paddingTop}) => paddingTop*1.5}vw;
    padding-left: ${({paddingLeft}) => paddingLeft*1.5}vw;
    padding-right: ${({paddingRight}) => paddingRight*1.5}vw;
    padding-bottom: ${({paddingBottom}) => paddingBottom*1.5}vw;

`;
const ImgDiv = styled.div`
    height: ${({height}) => height*1.5}vw;
    margin-top: ${({marginTop}) => marginTop*1.5}vw;
...
const IphoneMockupDiv = styled.div`
    height: ${({width}) => width*1.5}vw;
    width: ${({width}) => width}%;
    margin-top: ${({marginTop}) => marginTop*1.5}vw;
    margin-left: ${({marginLeft}) => marginLeft*1.5}vw;
    margin-right: ${({marginRight}) => marginRight*1.5}vw;
    float: ${({LorR}) => LorR === "L" ? "left" : "right"};
    position: relative;
