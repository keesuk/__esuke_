...
const TitleBoxLogoDiv = styled.div`
    ...
    background-color: ${({backGroundColor, logoTypeColor, hover}) => hover ? logoTypeColor : backGroundColor};
    transition: all .2s;
    position: relative;
    overflow: hidden;
    .logoOrigin {
    ...
    .logoType { fill: ${({logoBackColor, hover}) => hover ? logoBackColor : null};
`;
    ...
    return (
        ...
        >   
            <ReactCursorPosition 
                ...
                {...{ style, onActivationChanged: ({isActive}) => setHover(isActive)} }
            >
                <TitleBoxLogo 
                    logo={logo}
                    conCor={conCor}
