...
const TitleBoxLogo = ({
    ...
    return (
        <TitleBoxLogoDiv 
            ...
            logoWidth={logoWidth}
        >   
            <svg style={{position: "absolute", zIndex: "1", marginLeft: "auto", marginRight: "auto", left: "0", right: "0"}} className="logo">
                <defs>
                    <clipPath id="mask">
                        <circle id="mask-circle" cx={x-50} cy={y-50} r="10%" style={{fill: "#ffffff"}}/>
                    </clipPath>
                </defs>
