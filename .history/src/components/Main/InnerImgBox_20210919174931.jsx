...
const InnerImgBoxDiv = styled.div`
    ...
    margin-top: ${({marginTop}) => marginTop*1.4}vw;
    margin-bottom: ${({marginBottom}) => marginBottom*1.4}vw;
    padding-top: ${({paddingTop}) => paddingTop*1.4}vw;
    padding-left: ${({paddingLeft}) => paddingLeft*1.4}vw;
    padding-right: ${({paddingRight}) => paddingRight*1.4}vw;
    padding-bottom: ${({paddingBottom}) => paddingBottom*1.4}vw;

`;
const ImgDiv = styled.div`
    height: ${({height}) => height*1.4}vw;
    margin-top: ${({marginTop}) => marginTop*1.4}vw;
    margin-left: ${({marginLeft}) => marginLeft*1.4}vw;
    position: relative;
    .box {
        width: ${({width}) => width}%;
