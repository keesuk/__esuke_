...
import { portfolioContent } from "../../_data/_Data.jsx";
...
const FolioList = ({ folioArr, category, margin, exceptionName }) => {
    const folioList = findCategory(Object.values(folioArr), category, exceptionName)
