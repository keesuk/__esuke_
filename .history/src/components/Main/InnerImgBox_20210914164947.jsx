...
`;
const SubText = ({marginTop, marginBottom, marginLeft, marginRight, width, LorR, HorV, color}) => {
    return(
        <SubTextDiv
                marginTop={marginTop}  
...
const InnerImg = ({marginTop, marginLeft, width, height, LorR, outlineYorN, filterYorN, image, remark}) => {
    return(
        <InnerImgDiv 
            width={width}
            height={height}
