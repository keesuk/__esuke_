...
import { marking, numbering, useWindowSize, getSize } from "../../_data/_Functions.jsx";  
...
const InnerImgBoxDiv = styled.div`
    margin-left: ${({marginLayout}) => marginLayout}vw;
    background-color: ${({color}) => color};
    width: calc(100%-${({marginLayout}) => marginLayout}vw);
...
const InnerImgBox = ({paddingTop, paddingRight, paddingLeft, paddingBottom, marginTop, marginBottom, color, contents}) => {
    return(
        <InnerImgBoxDiv 
            marginLayout={getSize(winSize, marginLayout)}
