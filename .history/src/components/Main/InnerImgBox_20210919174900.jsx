...
const InnerImgBoxDiv = styled.div`
    ...
    margin-top: ${({marginTop}) => marginTop*0.3}vw;
    margin-bottom: ${({marginBottom}) => marginBottom*0.3}vw;
    padding-top: ${({paddingTop}) => paddingTop*0.3}vw;
    padding-left: ${({paddingLeft}) => paddingLeft*0.3}vw;
    padding-right: ${({paddingRight}) => paddingRight*0.3}vw;
    padding-bottom: ${({paddingBottom}) => paddingBottom*0.3}vw;

`;
const ImgDiv = styled.div`
    height: ${({height}) => height*0.3}vw;
    margin-top: ${({marginTop}) => marginTop*0.3}vw;
    margin-left: ${({marginLeft}) => marginLeft*0.3}vw;
    position: relative;
    .box {
        width: ${({width}) => width}%;
