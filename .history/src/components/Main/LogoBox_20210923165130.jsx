...
const TitleBoxLogo = ({
    position: {x, y}, 
    detectedEnvironment: {isMouseDetected, isTouchDected},
    isActive,
    conCor,
    logo }) => {
    ...
    useEffect(() => {
        const bool = isMobile(window, null)
        setMobile(bool)
    ...
    useEffect(() => {
        ...
        if( mobile === true) {
            if(isTouchDected === true) {
                setActive(true)
                console.log(isTouchDected)
            }
