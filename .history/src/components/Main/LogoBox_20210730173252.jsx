    ...
    return (
        ...
        >   
            ...
            <svg style={{position: "absolute", zIndex: "1", marginLeft: "auto", marginRight: "auto", left: "2vw", right: "0"}} className="logo">
                <circle id="circle-shadow" cx={x-120} cy={y-120} r="13%" style={{stroke: "#000", fill: "#fff", zIndex: "100",strokeWidth: "5"}} />
                <defs>
                    <clipPath id="mask">
                        <circle id="mask-circle" cx={x-120} cy={y-120} r="13%" style={{fill: "#ffffff", zIndex: "100"}}/>
                    </clipPath>
                </defs>
