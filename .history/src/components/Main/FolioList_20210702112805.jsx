...
const FolioListDiv = styled.div`
    ...
    .cellEmpty {
        ...
        .ment {
            color: ${theme.colorObjs["cellEmptyTextColor"]};
            font-size: ${theme.fontObjs["folioListCellEmpty"]["fontSize"]};
            font-weight: ${theme.fontObjs["folioListCellEmpty"]["fontWeight"]};
            font-family: ${theme.fontObjs["folioListCellEmpty"]["fontFamily"]};
            font-style: ${theme.fontObjs["folioListCellEmpty"]["fontStyle"]};
            position: absolute;
            left: 10%;
            white-space: nowrap;
            bottom: 0;
