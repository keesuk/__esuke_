...
const InnerImgBoxDiv = styled.div`
    ...
    margin-top: ${({marginTop}) => marginTop*3}vw;
    margin-bottom: ${({marginBottom}) => marginBottom*3}vw;
    padding-top: ${({paddingTop}) => paddingTop*3}vw;
    padding-left: ${({paddingLeft}) => paddingLeft*3}vw;
    padding-right: ${({paddingRight}) => paddingRight*3}vw;
    padding-bottom: ${({paddingBottom}) => paddingBottom*3}vw;
