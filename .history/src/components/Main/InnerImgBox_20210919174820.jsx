...
const InnerImgBoxDiv = styled.div`
    ...
    margin-top: ${({marginTop}) => marginTop + marginTop*0.3}vw;
    margin-bottom: ${({marginBottom}) => marginBottom + marginBottom*0.3}vw;
    padding-top: ${({paddingTop}) => paddingTop + paddingTop * 0.3}vw;
    padding-left: ${({paddingLeft}) => paddingLeft + paddingLeft * 0.3}vw;
    padding-right: ${({paddingRight}) => paddingRight + paddingRight * 0.3}vw;
    padding-bottom: ${({paddingBottom}) => paddingBottom + paddingBottom *0.3}vw;

`;
const ImgDiv = styled.div`
    height: ${({height}) => height + height*0.3}vw;
    margin-top: ${({marginTop}) => marginTop + marginTop*0.3}vw;
    margin-left: ${({marginLeft}) => marginLeft + marginLeft*0.3}vw;
    position: relative;
    .box {
        width: ${({width}) => width}%;
...
const TextDiv = styled.div`
    ...
    .korContents {
        ...
        word-spacing: .16rem;
        width: ${({width, HorV}) => HorV === "H" ? width/1.6 : width}%;
        text-align: justify;
