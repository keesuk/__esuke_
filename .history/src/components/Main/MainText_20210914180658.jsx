...
const MainText = ({ marginTop, marginBottom, color, text}) => {
            ...
            <div 
                ...
                dangerouslySetInnerHTML={{
                    __html : marking(
                        ...
                        `<mark>
                            <span class="text">
                                ${text["mark"]["title"]} <span class="num">${text["mark"]["num"]}</span>
                            </span>
                            <div class="markBoxInner">
                                <span class="titleText">${text["mark"]["title"]}/</span>
                                <span class="engText">${text["mark"]["textEng"]}</span>
                                <span class="korText">${text["mark"]["textKor"]}</span>
                            </div>
                        </mark>`
                )}}
            />
