...
const InnerImgBoxDiv = styled.div`
    ...
    margin-top: ${({marginTop}) => marginTop*1.3}vw;
    margin-bottom: ${({marginBottom}) => marginBottom*1.3}vw;
    padding-top: ${({paddingTop}) => paddingTop*1.3}vw;
    padding-left: ${({paddingLeft}) => paddingLeft*1.3}vw;
    padding-right: ${({paddingRight}) => paddingRight*1.3}vw;
    padding-bottom: ${({paddingBottom}) => paddingBottom*1.3}vw;

`;
const ImgDiv = styled.div`
    height: ${({height}) => height*1.3}vw;
    margin-top: ${({marginTop}) => marginTop*1.3}vw;
    margin-left: ${({marginLeft}) => marginLeft*1.3}vw;
    position: relative;
    .box {
        width: ${({width}) => width}%;
