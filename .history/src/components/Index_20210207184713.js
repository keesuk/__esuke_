...
const IndexDiv = styled.div`
    ...
    @media (max-width: 1750px) {transform: scale(0.55, 0.55)};
    @media (max-width: 1400px) {transform: scale(0.5, 0.5)};
    @media (max-width: 1150px) {transform: scale(0.45, 0.45)};
    @media (max-width: 900px) {transform: scale(0.4, 0.4)};
    @media (max-width: 750px) {transform: scale(0.35, 0.35)};
