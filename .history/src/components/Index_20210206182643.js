...
const IndexDiv = styled.div`
    ...
    .home { width: ${width}px; }
    .active { width: ${hoverWidth}px; box-shadow: 2px 2px 5px rgba(0, 0, 0, .4);}
    .inactive { width: ${0}px; }
...
const IndexObjectDiv = styled.div`
    ...
    &:hover .navlink { width: ${hoverWidth}px; box-shadow: 2px 2px 5px rgba(0, 0, 0, .4); }
    &:active .navlink { width: ${hoverWidth + 12}px; box-shadow: 2px 2px 5px rgba(0, 0, 0, .4);}
`;
