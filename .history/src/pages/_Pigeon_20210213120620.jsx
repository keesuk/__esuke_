...
const _Pigeon = () => {
    ...
    if (elRefs.current.length !== arrLen) elRefs.current = Array(arrLen).fill().map((_, i) => elRefs.current[i])
    ...
    return(<>
        ...
        <BackgroundPicDiv color={"black"} ref={elRefs[1]}>
            <div className="box">
