...
const _Pigeon = () => {
    ...
    useLayoutEffect(() => {
        const top = el.current.offsetTop - window.pageYOffset + el.current.clientTop
        const top_1 = el_1.current.offsetTop - window.pageYOffset + el_1.current.clientTop
        
        setElTop(top)
        setElTop_1(top_1)

        console.log(el.instance.getBoundingClientRect().top)
    ...
    return(<>
        ...
        <BackgroundPicDiv color={"black"} ref={el_1}>
            <div className="box">
