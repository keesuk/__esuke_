...
const _Seoul = () => {
    ...
    const { SubTitle, Remark, MainText, SubText, OuterImgBox, InnerImgBoxBackground, InnerImgBox, MarkBox, InnerVerticalBrowserMockupBox } = pageModules
