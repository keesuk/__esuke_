...
const Marks = styled.mark`
    ...
    &:hover {
        ...
        :before {
            ...
            background: linear-gradient(white, hotpink, #ee2267);
            width: 8.5rem;
            height: 4rem;
...
const _Pigeon = () => {
    const el = useRef()
    const [top, setElRefs] = useState(0)
    ...
    return(<>
        ...
        <PageStyleDiv><div>intro</div></PageStyleDiv>
        <MainText>
            <EngContentsDiv>
                <Marks>
        ...
        <PageStyleDiv><div>output</div></PageStyleDiv>
        <ImgBox marginTop={10}>
