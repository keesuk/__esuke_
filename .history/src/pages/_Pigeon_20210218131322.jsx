...
const _Pigeon = () => {
    ...
    return(
        <RightDiv>
            ...
            >
                <ImgBoxIn><img className="img" alt="" src={image["1"]["img"]}/></ImgBoxIn>
                <ImgBoxIn><img className="img" alt="" src={image["2"]["img"]}/></ImgBoxIn>
                <ImgBoxIn><img className="img" alt="" src={image["3"]["img"]}/></ImgBoxIn>
                <ImgBoxIn><img className="img" alt="" src={image["4"]["img"]}/></ImgBoxIn>
                <ImgBoxIn><img className="img" alt="" src={image["5"]["img"]}/></ImgBoxIn>
                <ImgBoxIn><img className="img" alt="" src={image["6"]["img"]}/></ImgBoxIn>   
            </ImgBoxBackground>
            <SubTitle>
