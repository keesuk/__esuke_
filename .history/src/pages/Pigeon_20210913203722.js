...
const _Pigeon = () => {
    const { name, pageStyle, title, year, category, color, logo, mainText, subText, image, bottomText } = PigeonContents
            ...
            >
                <div className="box">
                    ...
                    <Remark
                        ...
                        color={""}
                    >
                        <span className="remarkEng">{bottomText["txtEng"]}</span>
                        <span className="remarkKor">{bottomText["txtKor"]}</span>
                    </Remark>
                </div>
            </OuterImgBox>
            <MainText 
