...
const _Pigeon = (effect, deps, element, useWindow, wait) => {
    const el = useRef()
    const el_1 = useRef()
    ...
    useLayoutEffect(() => {
        ...
        const handleScroll = () => {
            ...
            if(el.current < currentScrollY && fixed)setFixed(false)
            if(el.current > currentScrollY && !fixed)setFixed(true)

            el.current = currentScrollY
