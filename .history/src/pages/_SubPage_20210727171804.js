...
const Sub = () => {
    ...
    const [translateAboutArr, setTranslateAboutArr] = useState(new Array(tagArr.length).map((i) => i))
                ...
                {location === "" 
                    ...
                    :   tagArr.map(([k, v], i) => 
                            <TagAbout 
                                key={k}
                                rotate={(i+1)*5}
                                onMouseEnter={() => updateAboutTranslate(i)}
                                onMouseLeave={() => updateAboutTranslate(i)}
                            >
                                {k === "Project Includes" 
