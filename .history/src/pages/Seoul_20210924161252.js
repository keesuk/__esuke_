...
const _Seoul = () => {
    ...
    return(
        <MainLayout>
            ...
            />
            <InnerImgBox
                paddingBottom={{deskTop: "13", mobile: ""}}
                paddingRight={{deskTop: "5", mobile: ""}}
                paddingLeft={{deskTop: "5", mobile: ""}}
                paddingTop={{deskTop: "10", mobile: ""}}
                marginBottom={{deskTop: "0", mobile: ""}}
                marginTop={{deskTop: "5", mobile: ""}}
                color={"#eeeeee"}
                contents={[{ 
                    type: "Browser",
                    width: "38", 
