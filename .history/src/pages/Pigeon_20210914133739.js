...
const _Pigeon = () => {
    ...
    const { SubTitle, Remark, SubText, OuterImgBox, InnerImgBoxBackground, InnerImgBox } = pageModules
    ...
    return(
        ...
        >
            ...
            <div style={{position : "sticky", top: "0px", transform: "scaleX(-1)", marginTop: "8%"}}><div style={{position: "absolute", transform: "rotate(90deg)", transformOrigin: "left top"}}>brief</div></div>
            <MainText 
                marginTop={"8"}
                marginBottom={"0"}
                mainText={mainText["0"]}
