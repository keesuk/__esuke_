...
const _WeDel = () => {
    const { name, footnote, title, category, color, logo, mainText, subText, image } = WeDelContents
    const { SubTitle, Remark, SubText, OuterImgBox, InnerImgBoxBackground, InnerImgBox, InnerIphoneMockupBox } = pageModules
