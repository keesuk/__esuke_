...
const _Pigeon = () => {
    return(<>
        ...
        <ImgBox marginTop={10}>
            <img alt="" src={Pigeon_Content1}/>
            <div className="remark">
            </div>
        </ImgBox>
        <TitlePicDiv color={"black"}>
            <div className="box">
                <img alt="" src={Pigeon_Content2}/>
                <img alt="" src={Pigeon_Content3}/>
                <img alt="" src={Pigeon_Content4}/>
                <img alt="" src={Pigeon_Content5}/>
                <img alt="" src={Pigeon_Content6}/>
                <img alt="" src={Pigeon_Content7}/>
            </div>
        </TitlePicDiv>
    </>)
}
