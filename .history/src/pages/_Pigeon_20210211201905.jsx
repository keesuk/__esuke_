...
const _Pigeon = () => {
    ...
    const [elTop1, setElTop1] = useState(null)

    useEffect(() => {
        const top = el.current.getBoundingClientRect()
        const top1 = el1.current.getBoundingClientRect()
        
        setElTop(top.bottom)
        setElTop1(top1.bottom)
    ...
    return(<>
        ...
        <PageStyleDiv top={elTop1}><div>output</div></PageStyleDiv>
        <TitleDiv>
