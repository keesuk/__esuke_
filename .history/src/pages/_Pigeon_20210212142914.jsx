...
const _Pigeon = () => {
    ...
    useEffect(() => {
        ...
        // el.addEventListener("scroll", onScroll, {pssive: true})
    ...
    const onScroll = (event) => {
        ...
        console.log('g')
        // setScrollPos(scroll.current.scrollTop)
        // console.log(scroll.current.scrollTop)
        // setScrollTop(e.target.documentElement.scrollTop)
        // if(elTop <= scrollTop)setFixed(true)
        // else setFixed(false)
    }


    return(
        <div className="ddd" onScroll={onScroll} ref={scroll}>
            <PageStyleDiv top={elTop} divTop={100}><div className={fixed ? "active" : ""}>· intro</div></PageStyleDiv>
