...
const PageStyle = ({el, text}) => {
    ...
    return <PageStyleDiv top={elTop} divTop={100}><div className={fixed ? "active" : ""}>{text}</div></PageStyleDiv>
}
...
const _Pigeon = () => {
    ...
    if (elRefs.current.length !== arrLen) elRefs.current = Array(arrLen).fill().map((_, i) => elRefs.current[i] || createRef());
    ...
    return(<>
        ...
        <MainText>
            <EngContentsDiv ref={elRefs.current[0]}>
                <Marks>
        ...
        <BackgroundPicDiv color={"black"} ref={elRefs.current[1]}>
            <div className="box">
