...
const PageStyle = (props) => {
    ...
    useLayoutEffect(() => {
        const top = props.el.current.getBoundingClientRect()

        if(props.el == null) return null
        else setElTop(top.y)
    }, [])

    return <PageStyleDiv top={elTop} divTop={100}><button className={fixed ? "active" : ""}>{props.text}</button></PageStyleDiv>
}
