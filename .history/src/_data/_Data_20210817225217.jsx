...
export const SamsaraContents = {
    ...
    subText : {
        "0" : {
            "color" : "black",
            "eng" : "is that they are temporary and provide a similar experience to consumers, such as similar guests, every year. This happens",
            "kor" : "페스티벌들의 한계는 한시적이고, 매년 비슷한 방식, 비슷한 게스트 등 소비자에게 유사할 "
        },
    },
    image : {
        "imgBoxBack" : theme.colorObjs["pigeonImgBoxBackColor"],
