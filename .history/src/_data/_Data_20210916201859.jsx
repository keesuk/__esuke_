...
export const SamsaraContents = {
    ...
    mainText : {
        "0" : {
            ...
            "kor" : "불교는 기원전 6세기경 인도의 고타마 싯다르타에 의해 창시된 인도 계통의 종교이다. 불교의 핵심 교리인 윤회는 그들만의 독특한 세계관을 지니고 있다. 나는 이들의 세계관이 지닌 독특한 매력을 위트있게 표현하고자 했다. 탱화나 기존 조각상이 지닌 엄숙한 혹은 장엄한 아우라를 장난스럽고 재미있는 표현을 통해 아이러니적 위트를 유발하고자 하였다.",
            "mark" : {
                "title" : "festival",
                "num" : "1",
