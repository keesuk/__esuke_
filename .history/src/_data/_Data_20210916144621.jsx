...
export const SeoulContents = {
    ...
    mainText : {
        ...
        "4" : {
            "eng" : "I thought that the idea of ​​image transformation was in line with the identity of the service, ‘the different Seoul cities we saw,’ so I created an image with various ornaments. The map production reflects the actual topography of Seoul and follows the rules of the route map familiar to viewers. Also, black and white was maintained in order not to be heterogeneous even when ornaments for visualization are included in the layer above the map. The categories and image data refer to the categories classified in the existing tourist satisfaction analysis data. Reference materials were classified into three categories: 'Attraction & Landmark', 'Shopping & Market', and 'Museum & Gallery', but this project has a different purpose. It was produced by classifying residences separately, categorizing residences in landmarks, and separating natural resorts and restaurants.",
            "kor" : "이미지 변형에 대한 아이디어는 서비스의 정체성인 ‘우리가 본 제 각기 다른 서울시’와 맞닿아있다 생각했고, 그렇기에 다양한 오너먼트들을 넣은 이미지를 제작하였다. 지도제작은 실제 서울지형을 반영하고, 보는 이들에게 익숙한 노선도 규칙을 따랐다. 또한, 지도 위 레이어에 시각화를 위한 오너먼트가 들어가도 이질적이지 않게 하기 위해 흑백을 유지하였다. 카테고리와 이미지 데이터는 기존 관광객 만족도 분석 자료에서 분류 놓은 카테고리를 참고하였다. 참고자료는 'Attraction & Landmark', 'Shopping & Market', 'Museum & Gallery' 세 가지로 분류했으나, 본 프로젝트는 다른 목적을 지녔으며, 서울에 유독 산과 강, 하천을 끼고 있는 지역들이 많아 음식점이나 거주지를 따로 분류하고, 랜드마크에 거주지를, 자연 휴양지와 음식점을 따로 분류해 제작하였다.",
            "mark" : {}
        },
    },
    subText : {
