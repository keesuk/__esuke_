...
export const WeDelContents = {
    ...
    mainText : {
        "0" : {
            ...
            "kor" : "위잇은 주식회사 위허들링의 메인 서비스이다. 회사의 미션은 모든 이들의 식사건강을 갖도록 하는 것이다. 대한민국 회사원 평균 조식 섭취비율은 전체 평균 52%, 나머지는 끼니를 거르거나 대충 떼운다. 그들이 아침 식사를 하지 못하는 대부분의 이유는 바쁜 출근시간에 끼니를 제대로 챙기기 어려움에 있었다. 정식은 고사하고 편의점에서 떼우는 것도 쉽지 않은 직장인들의 식사고충이 서비스의 페인포인트라고 보았고, 위잇 딜라이트(이하 위딜)는 이러한 문제를 해결하기 위해 탄생했다.",
            "mark" : [{
                "title" : "We Huddling",
                "num" : "1",
