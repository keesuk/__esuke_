...
export const GakkaContents = {
    ...
    mainText : {
        "0" : {
            "eng" : "As of 2020, the number of households raising companion animals in Korea exceeded 6.04 million households, and the market size exceeded KRW 3 trillion in 2018, growing at a rate of 50% every year. ",
        ...
        "1" : {
            ...
            "kor" : "하지만 이러한 거시적인 정책들은 반려동물 보유자의 직접적인 니즈 충족이 어렵다고 보았다. 반려동물 양육자 대상으로 도출된 설문결과 반려동물 양육의 가장 큰 고충은 산책을 시키기 어려운 여건이였다. 그에 따라 이를 대신할 애착인형이나 산책대행 서비스등이 나왔지만 근본적인 문제해결에 접근하지 못한다고 보았다. 그래서 '반려동물과 주인이 가까워지는 시간'을 갖을 수 있게 도와주는 브랜드 '가까'를 출시하고 제품 '산체크'를 제작하였다.",
            "mark" : {
                "title" : "Gakka",
                "num" : "1",
