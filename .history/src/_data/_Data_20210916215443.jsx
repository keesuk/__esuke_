...
export const SamsaraContents = {
    ...
    mainText : {
        "0" : {
            ...
            "kor" : "불교는 기원전 6세기경 인도의 고타마 싯다르타에 의해 창시된 인도 계통의 종교이다. 불교의 핵심 교리인 윤회는 그들만의 독특한 세계관을 지니고 있다. 나는 이들의 세계관이 지닌 그들만의 매력이 무거움에 반감된다 생각하며 그것은 불교가 지닌 어떠한 이미지에서 유발한다 보았다. 나는 그러한 진지함 속에 위트를 발견할 수 있다고 보았다. 본 프로젝트는 탱화나 기존 조각상이 지닌 엄숙한 혹은 장엄한 아우라를 장난스럽고 재미있는 표현을 통해 아이러니적 위트를 유발하고자 하였다.",
            "mark" : {
                "title" : "Samsara",
                "num" : "1",
