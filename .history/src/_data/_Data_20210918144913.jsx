...
export const WeDelContents = {
    ...
    mainText : {
        ...
        "2" : {
            ...
            "kor" : "위허들링의 황제펭귄을 주인공으로 새롭고 신비한 세계로 간다는 컨셉으로 정체성을 확립해갔다. 이를 위해 이상한 나라의 엘리스의 동화적 컨셉이나 분위기 옛 서적의 그래픽을 차용하였다. 또한 이러한 분위기를 더 하기위해 파티같은 연출을 더하였다.",
            "mark" : []
        },
    },
    subText : {
