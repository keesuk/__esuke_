...
export const OnvoyageContents = {
    ...
    mainText : {
        "0" : {
            ...
            "kor" : "우주여행을 웹 사이트에서 게임처럼 할 수 있다면 어떨까? 본 프로젝트는 지극히 개인적이고 추구하는 바가 명확한 취미 작업이다. 메타버스라는 용어가 등장하기 4년 전인 2016년 페이스북의 VR컨텐츠를 보고 영감을 받아 진행한 웹 메타버스 프로젝트다. 화면을 표현하기 위해 차용한 시각적인 모티브는 미래적인 UI를 구현한 구글과 아이언맨에서 다수 차용하였다. 또한, 매력적이라고 생각한 행성의 텍스쳐나 우주의 시점들을 지닌 이미지들을 활용하였다.",
            "mark" : {}
        },
    },
    subText : {
