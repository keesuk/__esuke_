...
export const WeDelContents = {
    ...
    mainText : {
        ...
        "3" : {
            "eng" : "We Eat Breakfast, which was born following We Del, is an online and offline link service to complement the lack of experience of We Del. We Del's weaknesses were that it was difficult to choose the food directly, there was no reason to understand the different foods that were selected, and the position was insufficient compared to strong competitors with similar businesses. Therefore, we needed a unique feature of We Eat, considering the health of eating.",
            "kor" : "위딜에 이어 탄생한 위잇 브렉퍼스트는 위딜의 세밀한 부분에서 나타난 부족한 경험들을 보완하고 극대화하기 위한 온오프라인 연계 서비스이다. 위딜의 가장 큰 약점은 선별된 각기 다른 음식에 대한 납득할 이유가 없는 점, 비슷한 비지니스를 하고 있는 강성한 경쟁사들에 비해 부족한 입지였다. 그렇기에 위잇만의 특장점이 필요했고, 그것을 위허들링의 미션인 식사 건강에 대한 고려이다.",
            "mark" : []
        },
        "4" : {
            "eng" : "Whit Breakfast was born for this reason. The service records meals through the app, recommends food according to the record and the user's eating habits, and provides food through a kiosk vending machine the next morning. This can be supplemented in that it is possible to provide a reason for prior consent and to closely manage health.",
            "kor" : "위잇 브렉퍼스트는 이러한 이유에 탄생했다. 서비스는 어플을 통해 식사를 기록하고 기록과 사용자의 식습관에 따라 음식을 추천하여 다음 날 아침 키오스크 자판기를 통해 음식을 제공한다. 이는 앞선 납득할 이유 제공과 건강에 대한 밀접한 관리가 가능하다는 점에서 보완이 될 수 있다.",
            "mark" : []
        },
        "5" : {
            "eng" : "With the emperor penguin of Weehudling as the main character, he established his identity with the concept of going to a new and mysterious world. For this purpose, the fairy tale concept and atmosphere of Alice in Wonderland were borrowed from old books. In addition, to increase the brightness and anticipation of Delight, a party-like direction was added.",
