...
export const RulerContents = {
    ...
    mainText : {
        ...
        "1" : {
            ...
            "kor" : "‘확대해석 본’은 이처럼 익숙하지만 놓치고 있던 우리 주변의 물건들에 대해 다시 해석하는 단체 프로젝트이다. 각자 주어진 물건에 대해 재밌는 해석을 줄 수 있는 내용을 구성하고 그에 맞는 8페이지의 편집작업을 진행하였다. 그 중 나는 자에 대해 접근하였고, 더불어 자와 연결되는 각도기나 도형 등 같이 확장될 수 있는 물건들도 함께 다루었다. 접근은 자라는 물성을 적극적으로 표현하기 위해 분석이라는 시각적 언어를 활용하였고, 이에 걸맞는 분해하고 재조합하는 논리적인 표현방식이 주로 나타났다. ",
            "mark" : {
...
export const GakkaContents = {
    ...
    mainText : {
        "0" : {
            "eng" : "As of 2020, the number of households raising companion animals in Korea is 6.04 million, or 14.48 million. In addition, the size of the companion animal market exceeded KRW 3 trillion in 2018, and is growing by 50% every year. However, the level of awareness of companion animals is far below that of the Animal Protection Act enacted by Germany in 1987. The 2020 policy report points out this and promotes national policies to improve awareness. However, these macro-policies saw that it was difficult to meet the direct needs of companion animal owners. As a result of the questionnaire drawn on companion animal caregivers, the biggest difficulty in raising companion animals was the difficult environment for taking a walk. As a result, attachment dolls and walking agency services were introduced to replace them, but they did not approach the fundamental problem solving. So, we launched a brand called 'Kakao' that helps pets and their owners get closer to each other.",
            "kor" : "대한민국 반려동물 양육 가구는 2020년 기준 604만 가구, 1448만명이다. 이에 더해 반려동물 시장 규모는 2018년 기준 3조원을 돌파하였고, 매년 50%씩 성장하고있다. 그러나 반려동물에 대한 인식수준은 1987년 독일이 제정한 동물보호법에 한참 못 미치는 수준이다. 2020년 정책보고서에는 이를 지적하며 인식수준을 개선할 국가단위의 정책들을 추진하고 있다. 하지만 이러한 거시적인 정책들은 반려동물 보유자의 직접적인 니즈 충족이 어렵다고 보았다. 반려동물 양육자 대상으로 도출된 설문결과 반려동물 양육의 가장 큰 고충은 산책을 시키기 어려운 여건이였다. 그에 따라 이를 대신할 애착인형이나 산책대행 서비스등이 나왔지만 근본적인 문제해결에 접근하지 못한다고 보았다. 그래서 '반려동물과 주인이 가까워지는 시간'을 갖을 수 있게 도와주는 브랜드 '가까'를 출시하였다.",
            "mark" : {
                "title" : "festival",
                "num" : "1",
