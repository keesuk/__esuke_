...
export const OnvoyageContents = {
    ...
    mainText : {
        "0" : {
            "eng" : "What if space travel could be played like a game on a website? This project is a very personal and clear work. In 2016, four years before the term metaverse appeared, I saw Facebook's VR content and was inspired to proceed with the project. I made a UI for space and earth travel by referring to the textures of the universe or UIs that appear in Iron Man.",
            "kor" : "우주여행을 웹 사이트에서 게임처럼 할 수 있다면 어떨까. 본 프로젝트는 지극히 개인적이고 추구하는 바가 명확한 작업이다. 메타버스라는 용어가 등장하기 4년 전인 2016년 페이스북의 VR컨텐츠를 보고 영감을 받아 프로젝트를 진행했다. 우주의 텍스쳐나 아이언맨에 등장하는 UI들을 참조하여 우주와 지구여행을 하는 UI를 제작하였다.",
            "mark" : {}
        },
    },
    subText : {
