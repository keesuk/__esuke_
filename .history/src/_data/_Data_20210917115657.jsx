...
export const GakkaContents = {
    ...
    mainText : {
        "0" : {
            ...
            "kor" : "대한민국 반려동물 양육 가구는 2020년 기준 604만 가구, 1448만명이다. 이에 더해 반려동물 시장 규모는 2018년 기준 3조원을 돌파하였고, 매년 50%씩 성장하고있다. 그러나 반려동물에 대한 인식수준은 1987년 독일이 제정한 동물보호법에 한참 못 미치는 수준이다. 2020년 정책보고서에는 이를 지적하며 인식수준을 개선할 국가단위의 정책들을 추진하고 있다. 하지만 이러한 거시적인 정책들은 반려동물 보유자의 ",
            "mark" : {
                "title" : "festival",
                "num" : "1",
