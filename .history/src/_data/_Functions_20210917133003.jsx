...
export function marking(text, content, mark){
    var txt = text 
    var arr = content
    ...
    for(var i = 0; i < arr.length; i++){
        ...
        html.replace(arr[i]["title"], /TITLE/g)
        console.log(html.replace(i+1, "NUM"))
        html.replace(arr[i]["textEng"], "TEXTENG")
        html.replace(arr[i]["textKor"], "TEXTKOR")

        txt.replace(arr[i]["title"], html)
        console.log(txt)
    }
