...
export const WeDelContents = {
    ...
    mainText : {
        ...
        "3" : {
            "eng" : "Wiit Breakfast, which was born following WithDeal, is an online and offline link service to complement and maximize the lack of experience in the details of WithDeal. Wedil's weaknesses were that it was difficult to choose the food directly, there was no reason to understand the different foods that were selected, and the position was insufficient compared to strong competitors with similar businesses. Therefore, we needed a unique feature of Weit, and that is the mission of We Hurdling, considering the health of eating.",
        ...
        "4" : {
            "eng" : "With the emperor penguin of Weehudling as the main character, he established his identity with the concept of going to a new and mysterious world. For this purpose, the fairy tale concept and atmosphere of Alice in Wonderland were borrowed from old books. In addition, to increase the brightness and anticipation of Delight, a party-like direction was added.",
            "kor" : "위잇 브렉퍼스트는 이러한 이유에 탄생했다. 서비스는 어플을 통해 식사를 기록하고 기록과 사용자의 식습관에 따라 음식을 추천하여 다음 날 아침 키오스크 자판기를 통해 음식을 제공한다. 이는 앞선 납득할 이유 제공과 건강에 대한 케어를 할 수 있다는 점에서 보완이 되었다. 그러나 어플을",
            "mark" : []
        },
    },
    subText : {
