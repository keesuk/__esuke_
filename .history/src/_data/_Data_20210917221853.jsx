...
export const WeDelContents = {
    ...
    mainText : {
        ...
        "1" : {
            ...
            "kor" : "위딜은 사내 복지용 아침 구독 서비스이다. 사무실에 냉장고를 설치하고, 구독을 한 사원들을 대상으로 추구하는 식사 스타일을 정보를 받은 뒤 식품 전문 MD가 선별한 매일 다른 신선한 아침을 제공한다. 사용자들의 대부분은 매일 아침이 기대된다고 말했으며, 동료직원들과 받은 아침들을 비교하며, 색다른 경험을 준다.",
            "mark" : []
        },
    },
    subText : {
