...
export const OnvoyageContents = {
    ...
    mainText : {
        "0" : {
            "eng" : "What if space travel could be played like a game on a website? This project is a very personal and clear hobby work. In 2016, four years before the term metaverse appeared, I saw Facebook's VR content and was inspired to proceed with the project. Many of the visual motifs were borrowed from Google and Iron Man, who implemented futuristic UI. Also, images with planetary textures or cosmic viewpoints were used that I thought were attractive.",
            "kor" : "우주여행을 웹 사이트에서 게임처럼 할 수 있다면 어떨까? 본 프로젝트는 지극히 개인적이고 추구하는 바가 명확한 취미 작업이다. 메타버스라는 용어가 등장하기 4년 전인 2016년 페이스북의 VR컨텐츠를 보고 영감을 받아 프로젝트를 진행했다. 시각적인 모티브는 미래적인 UI를 구현한 구글과 아이언맨에서 다수 차용하였다. 또한, 매력적이라고 생각한 행성의 텍스쳐나 우주의 시점들을 지닌 이미지들을 활용하였다.",
            "mark" : {}
        },
    },
    subText : {
