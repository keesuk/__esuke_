...
export const SeoulContents = {
    ...
    mainText : {
        ...
        "1" : {
            ...
            "kor" : "로고는 의미 그대로 시민 개개인이 생각하는 다양한 서울시에 대한 이미지의 공감이 일어남과 동시에, 서비스의 성격을 제시할 수 있어야 한다고 생각했습니다. 이를 위해, 두가지의 관점을 적용시켰습니다. 첫번째, 서울시 요소요소(한강, 고궁, 기존로고, 빌딩)를 로고에 묘사하였습니다. 두번째는 글자 개개의 구성요소(자형, 오너먼트, 위치)를 다르게 하여 개성에 대해 강조하였습니다. <br/>서비스 전체의 흐름을 이끌어 갈 키비주얼을 상정함에 있어 고려되어야 할 요소 첫번째는 데이터 시각화가 용이할 것, 두번째는 디자인적 정체성이 일관되어야 하는 것 이었습니다. 그 중 두번째인 디자인적인 정체성을 설정함에 있어, 원, 세모, 네모, 마름모, 타원은 오너먼트 각각의 개성이 들어나면서 기하도형이라는 하나의 공통 카테고리 안에 묶여 있는 점이 서울시민이라는 공통점을 지니면서 개개인의 개성이 다르다는 것의 표현이 적절하였습니다.",
            "mark" : {}
        },
    },
    subText : {
