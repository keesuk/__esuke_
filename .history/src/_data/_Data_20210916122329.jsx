...
export const SeoulContents = {
    ...
    mainText : {
        "0" : {
            "eng" : "Each region has a different meaning in each individual's experience. Therefore, the specific area I see may or may not be the same as the point of view of others. The Seoul project we saw was made with this idea in mind. Seoul, the representative city of Korea, is a place where a large number of people come and go, so it has a relatively wide consensus compared to other cities. Therefore, even when looking at a specific area, Seoul can have a variety of perspectives, and sympathy or unfamiliar emotions can be felt in it. The Seoul project we saw aims to visualize data that can be sympathetic by reconstructing different perspectives and memories. Through this, we want to draw an empathy map through emotional data of various people.",
            "kor" : "지역은 개개인의 경험 속 저마다의 다른 의미가 존재합니다.  그렇기 때문에 내가 보는 특정 지역은 타인이 보는 관점과 다를 수도, 같을 수도 있습니다.  우리가 본 서울시 프로젝트는 이러한 아이디어에 착안하여 제작 되었습니다.  대한민국을 대표하는 도시 서울은 방대한 사람들이 오가는 곳이기에 타도시에 비해 비교적 넓은 공감대를 지니고 있습니다. 때문에 서울시는 특정지역을 보더라도 다양한 관점이 나올 수 있고, 그 속에서 공감 혹은 낯선 감정들을 느낄 수 있습니다.  우리가 본 서울시  프로젝트는 저마다의 다른 관점, 추억을 재구성하여 공감이 될 수 있는 데이터 시각화를 목표로 합니다. 이를 통해 여러 사람들의 감정 데이터를 통한 공감지도를 그려보고자 합니다.",
            "mark" : {
                "title" : "Pigeon",
                "num" : "1",
                "textEng" : "Pigeon with the slogan 'Pigeon for laundry' is a Korean detergent company with 43 years of history. The products it sells cover a full range of products that target housewives, such as detergents, textiles, and kitchenware, and the main selling product is fabric softener.",
