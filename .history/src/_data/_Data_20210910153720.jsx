...
export const PigeonContents = {
    ...
    mainText : {
        "0" : {
            ...
            "kor" : "피죤은 대한민국 화확제품 및 세제 회사이다. 현재 사용되고 있는 로고는 1998년에 제작되었으며, 당시 피죤의 주력 판매 제품은 세제였다. 사업의 다각화로 현재 피죤이 주력으로 판매하고자 하는 상품은 TV광고나 홈페이지 메인에 반복적으로 등장하는 섬유유연제라 판단된다. 그러나 피죤의 로고는 30년 전의 세제 느낌 그대로 머물러 있다 생각되며, 이는 섬유유연제의 셀링 포인트인 향기에 대한 어필의 부족을 뜻한다. 그래서 나는 본 프로젝트를 통해 피죤의 판매 전략과 결이 맞는 로고와 피죤이라는 브랜드를 소개할 수 있는 출판물을 제작하려 한다.",
            "mark" : {
                "title" : "festival",
                "num" : "1",
