...
export const SeoulContents = {
    ...
    subText : {
        ...
        "1" : {
            ...
            "kor" : "사용자는 자신이 알거나 익숙한 지역에 대한 데이터를 입력합니다.해당 이미지는 흔히 알고 있는 사진이 아닌 정제된 형태로서 나타납니다. 정제는 데이터적 관점에서 정확히 알고 있는지에 대한 확인여부와 함께 사용자 관점에서 익숙한 지역에 대해 공감대를 이끌 수 있기 때문입니다. 이미지를 클릭하면 구성하는 오너먼트들을 변형시킵니다. "
        },
    },
    bottomText :{
        "0" : {
