...
export const line_1 = ".2em solid black"
export const line_2 = ".13em solid"
export const line_3 = "2px solid black"
export const line_4 = "2em solid rgba(250, 250, 0, .8)"

export const introDiv_introduce = <><strong>Keesuk Lee</strong> is a <strong>graphic Designer</strong> and <strong>Developer</strong> living in Seoul, S.Korea.</>
