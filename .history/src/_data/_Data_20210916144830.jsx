...
export const SeoulContents = {
    ...
    mainText : {
        ...
        "4" : {
            "eng" : "I thought that the idea of ​​image transformation was in line with the identity of the service, ‘the different Seoul cities we saw,’ so I created an image with various ornaments.",
            "kor" : "이미지 변형에 대한 아이디어는 서비스의 정체성인 ‘우리가 본 제 각기 다른 서울시’와 맞닿아있다 생각했고, 그렇기에 다양한 오너먼트들을 넣은 이미지를 제작하였다.",
            "mark" : {}
        },
        "5" : {
            "eng" : "The map production reflects the actual topography of Seoul and follows the rules of the route map familiar to viewers. Also, black and white was maintained in order not to be heterogeneous even when ornaments for visualization are included in the layer above the map.",
            "kor" : "지도제작은 실제 서울지형을 반영하고, 보는 이들에게 익숙한 노선도 규칙을 따랐다. 또한, 지도 위 레이어에 시각화를 위한 오너먼트가 들어가도 이질적이지 않게 하기 위해 흑백을 유지하였다.",
            "mark" : {}
        },
        "6" : {
