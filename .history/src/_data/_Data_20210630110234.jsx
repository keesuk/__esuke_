...
export const otherLink = [
    {
        ...
        "color": theme.colors["instagramColor"]
    },{
        "title" : "Github", 
        "link" : "https://github.com/keesuk", 
        "color": theme.colors["githubColor"],
    }
]
...
export const menu_menu = [
    {   
        ...
        "deepColor": theme.colors["deepYellow"],
        "left" : "134px",
        "leftText" : "101px",
        "height" : "67px",
        "margin" : "-101px",
        ...
        "deepColor": theme.colors["deepPink"],
        "left" : "48px",
        "leftText" : "15px",
        "height" : "150px",
        "margin" : "-184px",
...
export const PigeonContents = {
    ...
    logo: <PigeonLogo/>,
    color : {
        "main" : theme.colors["pigeonColor"],
        "subColor" : theme.colors["hotPink"],
    },
    pageStyle : [
        "· intro", 
        "· output"
